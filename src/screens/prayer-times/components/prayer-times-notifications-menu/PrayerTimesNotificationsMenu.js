...
export default function PrayerTimesNotificationsMenu() {
    ...
    // Notifications Menu
    const isNotificationsMenuVisible = useSelector((state) => state.prayerTimes.isNotificationsMenuVisible);
                        ...
                        <View style={styles.menuOptionsContainer}>
                            ...
                            <View style={styles.optionContainer}>
                                <Switch 
                                    ...
                                    thumbColor={ isPrayerTimesNotificationsActive? DARK_GOLD : DARK_GREY}
                            ...
                            <View style={styles.optionContainer}>
                                <Switch 
                                    style = {{transform: [{scaleX: 1.5}, {scaleY: 1.5}]}}
                                    trackColor={{false: DARK_GREY, true: PRIMARY_GOLD}}
                                    thumbColor={ isMuteDuringPrayerTimesActive? DARK_GOLD : DARK_GREY}
